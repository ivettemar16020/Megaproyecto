                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image:
                                      AssetImage("assets/images/copa2.png"))),
                        ),
                        SizedBox(width: 5),
                        Column(
                          ...
                          children: <Widget>[
                            new Column(
                              children: <Widget>[
                                ...
                                new Text(
                                    "¡Has finalizado el primer test de asertividad!"),
                                new Row(
                        ...
                        child: new Column(
                          children: <Widget>[
                            new Column(
                              children: <Widget>[
                                new IconButton(
                                    icon: FaIcon(FontAwesomeIcons.starOfLife,
                                        color: Colors.orange),
                                    onPressed: () {}),
                                new Container(
                                  child: new Text("NUEVA RACHA"),
                                  color: Colors.yellow[200],
                                ),
                                new Container(
                                  height: 15.0,
                          ...
                          children: <Widget>[
                            new Column(
                              children: <Widget>[
                                ...
                                new Text(
                                    "¡Has decidido realizar tu primer módulo!"),
                                new Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: <Widget>[
                                    new Container(
