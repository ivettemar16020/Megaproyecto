...
import 'package:frontend/autoestima/CretoOne.dart';
import 'package:frontend/autoestima/BretoTwo.dart';
import 'package:frontend/autoestima/BretoThree.dart';

class AutoThreeRetosPage extends StatefulWidget {
  @override
  _AutoThreeRetosPageState createState() => _AutoThreeRetosPageState();
}

class _AutoThreeRetosPageState extends State<AutoThreeRetosPage> {
  @override
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Controla tus propios escenarios',
                                      style: TextStyle(
                                          fontSize: 20,
